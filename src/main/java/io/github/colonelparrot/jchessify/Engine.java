...
public class Engine {
	...
	/**
	 * Indicates the maximum depth for the minimax algorithm to search <br /><br />
	 ...
	 * Calculates the best move to play <br /><br />
	 * MINIMAX works by going down a move tree <br />
	 * &emsp; each side must play the best move for themselves <br />
	 * &emsp; we simply find the move that, assuming both sides play their best, yields the best outcome <br />
	 ...
	 * @return an evaluation of the board position, see comments for more technical details
	 */
